...
const DESCRIPTIONS: Record<string, string> = {
  ...
  crude_oil_cif_volume: "財務省「普通貿易統計」に基づく原油（HS 2709）の月次輸入数量（万KL）。需要動向や在庫積み増しの把握に活用できる。月次・約2ヶ月遅延。",
  crude_oil_cif:  "財務省「普通貿易統計」に基づく原油（HS 2709）の月次CIF輸入単価。CIF（Cost, Insurance, Freight）は運賃・保険料込みの価格。日本が実際に輸入した原油（主に中東産）の平均コストを示し、WTI・Brentより国内エネルギー価格への影響を直接反映する。月次・約2ヶ月遅延。",
  lng_cif:        "財務省「普通貿易統計」に基づくLNG（HS 271111）の月次CIF輸入単価。CIF（Cost, Insurance, Freight）は運賃・保険料込みの価格。日本が実際に輸入したLNGの平均コストを示し、都市ガス・電気代への影響を直接反映する。月次・約2ヶ月遅延。",
  lng_cif_volume: "財務省「普通貿易統計」に基づくLNG（HS 271111）の月次輸入数量（万トン）。需要動向や在庫積み増しの把握に活用できる。月次・約2ヶ月遅延。",
  ...
  coal_cif:        "財務省「普通貿易統計」に基づく一般炭（HS 27011209）の月次CIF輸入単価。CIF（Cost, Insurance, Freight）は運賃・保険料込みの価格。日本が発電用に輸入した石炭の平均コストを示し、電気代への影響を直接反映する。月次・約2ヶ月遅延。",
  coal_cif_volume: "財務省「普通貿易統計」に基づく一般炭（HS 27011209）の月次輸入数量（万トン）。発電用石炭の需要動向の把握に活用できる。月次・約2ヶ月遅延。",
  ...
  eur_jpy:        "ユーロ対日本円の為替レート。TTF（欧州天然ガス）やBrent原油などユーロ建て取引の円換算コストに影響する。",
  jpy_neer:       "BIS（国際決済銀行）が算出する円の名目実効為替レート。主要貿易相手国通貨に対する円の加重平均レートを指数化（2020年=100）。指数低下が円安を示す。月次・約2ヶ月遅延。",
  ...
  gasoline_wholesale: "資源エネルギー庁「石油製品価格調査」による石油元売りのレギュラーガソリン出荷価格（税抜）。小売価格の先行指標。月次・約2ヶ月遅延。",
